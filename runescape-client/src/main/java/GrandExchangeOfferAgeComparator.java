...
final class GrandExchangeOfferAgeComparator implements Comparator {
	...
	static final void method248(Scene scene, CollisionMap[] var1) {
		...
		for (z = 0; z < 4; ++z) {
			...
			for (int y = 1; y < 103; ++y) {
				for (int x = 1; x < 103; ++x) {
					int xHeightDiff = Tiles.Tiles_heights[z][x + 1][y] - SceneRegion.Tiles_heights[z][x - 1][y];
					int yHeightDiff = Tiles.Tiles_heights[z][x][y + 1] - SceneRegion.Tiles_heights[z][x][y - 1];
					...
					Tiles.tileColors[x][y] = var19 - var20;
				}
			}
			...
			for (int xi = -5; xi < 109; ++xi) {
				...
				if (xi >= 1 && xi < 103) {
					...
					for (int yi = -5; yi < 109; ++yi) {
						...
						if (yi >= 1 && yi < 103 && (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][xi][yi] & 2) != 0 || (SceneRegion.Tiles_renderFlags[z][xi][yi] & 16) == 0)) {
							...
							if (underlayId > 0 || overlayId > 0) {
								...
								int swColor = Tiles.tileColors[xi][yi];
								int seColor = Tiles.tileColors[xi + 1][yi];
								int neColor = Tiles.tileColors[xi + 1][yi + 1];
								int nwColor = Tiles.tileColors[xi][yi + 1];
								int rgb = -1;
								int underlayHsl = -1;
								...
								if (z > 0) {
									...
									if (var47 && swHeight == seHeight && neHeight == swHeight && swHeight == nwHeight) {
										var10000 = WorldMapSection3.field404[z][xi];
										var10000[yi] |= 2340;
									}
								}
			...
			for (int zi = 0; zi <= renderLevel; ++zi) {
				for (int yi = 0; yi <= 104; ++yi) {
					for (int xi = 0; xi <= 104; ++xi) {
						short var46;
						if ((WorldMapSection3.field404[zi][xi][yi] & z) != 0) {
							var9 = yi;
							var10 = yi;
							var11 = zi;

							for (var12 = zi; var9 > 0 && (WorldMapSection3.field404[zi][xi][var9 - 1] & z) != 0; --var9) {
							}

							while (var10 < 104 && (WorldMapSection3.field404[zi][xi][var10 + 1] & z) != 0) {
								++var10;
							}
							...
							while (var11 > 0) {
								for (var13 = var9; var13 <= var10; ++var13) {
									if ((WorldMapSection3.field404[var11 - 1][xi][var13] & z) == 0) {
										break label465;
									}
								}
							...
							while (var12 < renderLevel) {
								for (var13 = var9; var13 <= var10; ++var13) {
									if ((WorldMapSection3.field404[var12 + 1][xi][var13] & z) == 0) {
										break label454;
									}
								}
							...
							if (var13 >= 8) {
								...
								for (var17 = var11; var17 <= var12; ++var17) {
									for (var18 = var9; var18 <= var10; ++var18) {
										var10000 = WorldMapSection3.field404[var17][xi];
										var10000[var18] &= ~z;
									}
								}
							}
						...
						if ((WorldMapSection3.field404[zi][xi][yi] & var3) != 0) {
							var9 = xi;
							var10 = xi;
							var11 = zi;

							for (var12 = zi; var9 > 0 && (WorldMapSection3.field404[zi][var9 - 1][yi] & var3) != 0; --var9) {
							}

							while (var10 < 104 && (WorldMapSection3.field404[zi][var10 + 1][yi] & var3) != 0) {
								++var10;
							}
							...
							while (var11 > 0) {
								for (var13 = var9; var13 <= var10; ++var13) {
									if ((WorldMapSection3.field404[var11 - 1][var13][yi] & var3) == 0) {
										break label518;
									}
								}
							...
							while (var12 < renderLevel) {
								for (var13 = var9; var13 <= var10; ++var13) {
									if ((WorldMapSection3.field404[var12 + 1][var13][yi] & var3) == 0) {
										break label507;
									}
								}
						...
						if ((WorldMapSection3.field404[zi][xi][yi] & var4) != 0) {
							...
							for (var12 = yi; var11 > 0 && (WorldMapSection3.field404[zi][xi][var11 - 1] & var4) != 0; --var11) {
							}

							while (var12 < 104 && (WorldMapSection3.field404[zi][xi][var12 + 1] & var4) != 0) {
								++var12;
							}
							...
							while (var9 > 0) {
								for (var13 = var11; var13 <= var12; ++var13) {
									if ((WorldMapSection3.field404[zi][var9 - 1][var13] & var4) == 0) {
										break label571;
									}
								}
							...
							while (var10 < 104) {
								for (var13 = var11; var13 <= var12; ++var13) {
									if ((WorldMapSection3.field404[zi][var10 + 1][var13] & var4) == 0) {
										break label560;
									}
								}
							...
							if ((var12 - var11 + 1) * (var10 - var9 + 1) >= 4) {
								...
								for (var14 = var9; var14 <= var10; ++var14) {
									for (var15 = var11; var15 <= var12; ++var15) {
										var10000 = WorldMapSection3.field404[zi][var14];
										var10000[var15] &= ~var4;
									}
								}
							}
